...
slug: conversational-ai/libraries/conversational-ai-sdk-js
---
...
will request a signed url using the [ElevenLabs API](https://elevenlabs.io/docs/api-reference/introduction) and pass it back to the client.
